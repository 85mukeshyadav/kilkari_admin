...
export const create3DScene = (t3d, canvas) => {
  ...
  var light = new THREE.SpotLight(0x000000,4000);
...
dirLight.position.set(0, 0, -10.0)
...
export const prepareModelNodes = (t3d) => {
  ...
  for(let i = 0; i < modelNodes.length; i++) {
    ...
    // modelNode.rotation.set(0.0, 0, 0);
    // modelNode.position.set(0.0, -8.0, 0.0)
    // modelNode.scale.multiplyScalar(1.0);
  return true
}
