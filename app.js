...
var cronManager = require('./helper/cronmanager');
const SystemCronRouter = require('./routes/crons');
...
// Cron Part
async function cronInitiator() {
    cronManagerInit = await cronManager.initAllSystemCrons();
    if (cronManagerInit) {
        console.log('System cron initiated');
    }
};
...
app.use('/', indexRouter);
app.use('/crons',SystemCronRouter);
